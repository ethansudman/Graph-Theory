...
#  This is an alternative entry point for the A* algorithm.
#  Again, this must be run in Python 2.7.1, it won't work in python 3.*
#  I did not write this program but rather "inherited" it as part of the original assignment
#
from Tkinter import *
